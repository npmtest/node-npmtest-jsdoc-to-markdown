...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsdoc-to-markdown/node_modules/jsdoc-to-markdown/lib/jsdoc-to-markdown.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-jsdoc-to-markdown">npmtest-jsdoc-to-markdown (v0.0.3)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-jsdoc-to-markdown/node_modules/jsdoc-to-markdown/lib/jsdoc-to-markdown.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsdoc-to-markdown/node_modules/jsdoc-to-markdown/lib/</a> &#187; jsdoc-to-markdown.js</div>
</div>
<div class="body">
...
class JsdocToMarkdown {
   ...
   * ```
   */
  render <span class="fstat-no" title="function not covered" >(options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options || {}</span>
<span class="cstat-no" title="statement not covered" >    const dmdOptions = new DmdOptions(options)</span>
<span class="cstat-no" title="statement not covered" >    if (options.data) {</span>
<span class="cstat-no" title="statement not covered" >      return dmd.async(options.data, dmdOptions)</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return this.getTemplateData(options)</span>
        .then(templateData =&gt; <span class="cstat-no" title="statement not covered" >dmd.async(templateData, dmdOptions))</span>
    }
  }
&nbsp;
  /**
   ...
   */
  renderSync <span class="fstat-no" title="function not covered" >(options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options || {}</span>
<span class="cstat-no" title="statement not covered" >    const dmdOptions = new DmdOptions(options)</span>
<span class="cstat-no" title="statement not covered" >    if (options.data) {</span>
<span class="cstat-no" title="statement not covered" >      return dmd(options.data, dmdOptions)</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return dmd(this.getTemplateDataSync(options), dmdOptions)</span>
    }
  }
&nbsp;
  /**
   ...
   * @category async
   */
  getTemplateData <span class="fstat-no" title="function not covered" >(options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options || {}</span>
<span class="cstat-no" title="statement not covered" >    const jsdocParse = require('jsdoc-parse')</span>
<span class="cstat-no" title="statement not covered" >    return this.getJsdocData(options)</span>
      .then(jsdocParse)
  }
&nbsp;
  /**
   ...
   * @category sync
   */
  getTemplateDataSync <span class="fstat-no" title="function not covered" >(options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options || {}</span>
<span class="cstat-no" title="statement not covered" >    const jsdocParse = require('jsdoc-parse')</span>
<span class="cstat-no" title="statement not covered" >    const jsdocData = this.getJsdocDataSync(options)</span>
<span class="cstat-no" title="statement not covered" >    return jsdocParse(jsdocData, options)</span>
  }
&nbsp;
  /**
   ...
   * @category async
   */
  getJsdocData <span class="fstat-no" title="function not covered" >(options) {</span>
<span class="cstat-no" title="statement not covered" >    const jsdocOptions = new JsdocOptions(options)</span>
<span class="cstat-no" title="statement not covered" >    return jsdocApi.explain(jsdocOptions)</span>
  }
&nbsp;
  /**
   ...
   * @category sync
   */
  getJsdocDataSync <span class="fstat-no" title="function not covered" >(options) {</span>
<span class="cstat-no" title="statement not covered" >    const jsdocOptions = new JsdocOptions(options)</span>
<span class="cstat-no" title="statement not covered" >    return jsdocApi.explainSync(jsdocOptions)</span>
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    return jsdocApi.cache.clear().then(() =&gt; <span class="cstat-no" title="statement not covered" >dmd.cache.clear())</span></span>
  }
&nbsp;
  /**
   ...
   * @category async
   */
  getNamepaths <span class="fstat-no" title="function not covered" >(options) {</span>
<span class="cstat-no" title="statement not covered" >    return this.getTemplateData(options)</span>
      .then(data =&gt; {
<span class="cstat-no" title="statement not covered" >        const namepaths = {}</span>
<span class="cstat-no" title="statement not covered" >        const kinds = [</span>
          'module', 'class', 'constructor', 'mixin', 'member',
          'namespace', 'constant', 'function', 'event', 'typedef', 'external'
        ]
<span class="cstat-no" title="statement not covered" >        kinds.forEach(kind =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          namepaths[kind] = data</span>
            .filter(identifier =&gt; {
<span class="cstat-no" title="statement not covered" >              return identifier.kind === kind</span>
            })
            .map(identifier =&gt; <span class="cstat-no" title="statement not covered" >identifier.longname)</span>
        })
<span class="cstat-no" title="statement not covered" >        return namepaths</span>
      })
  }
}
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Thu Apr 27 2017 16:52:42 GMT+0000 (UTC)</div>
</div>
</body>
</html>
